...
import { UserRegisteredEventListener } from "./app/events/listeners/user-registered-event-listener";
...
const start = async () => {
  ...
  // Listen for user registeration events
  await new UserRegisteredEventListener(natsWrapper.client).listen();
  // Run server
  app.listen(3000, () => {
